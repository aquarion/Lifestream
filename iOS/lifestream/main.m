...
int main(int argc, char *argv[]) {
    ...
    @autoreleasepool {
        ...
        main_script = [
            [[NSBundle mainBundle] pathForResource:@"Library/Application Support/org.python.lifestream/app/lifestream/__main__"
                                            ofType:@"py"] cStringUsingEncoding:NSUTF8StringEncoding];

        if (main_script == NULL) {
            NSLog(@"Unable to locate lifestream main module file");
            exit(-1);
        }
