...
# curl -X POST -d
# '{"password":"not-a-real-password","email":"not-a-real-email@example.com"}'
...
if "projects" not in kickstarter:
    print kickstarter
    sys.exit(5)
...
for project in kickstarter['projects']:
    ...
    Lifestream.add_entry(
        ...
        date=date,
        image=photo,
        fulldata_json=project)


# This code is to "catch up" from kickstarter history, you should only
# need to do it once. Uncomment it when you do.
