...
$saintCoinachPath = $iniFile.local.icon_local_base
...
Write-Host "Ensuring SaintCoinach directory exists..."

# Create directory if it doesn't exist
if (-not (Test-Path $saintCoinachPath)) {
  New-Item -ItemType Directory -Path $saintCoinachPath -Force
  Write-Output "Created directory $saintCoinachPath"
}
